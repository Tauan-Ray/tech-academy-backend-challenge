...
@APIResponse(
    responseCode = "200",
    description = "Lista de matrículas encontradas para a sala informada",
    content = [
        Content(
...
@APIResponse(
    responseCode = "404",
    description = "Sala de aula não encontrada"
)
annotation class FindEnrollmentsByClassroomDoc
